      ...
      <header className="mb-8 md:mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-2">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#369094]/10 text-[#2d7479] border border-[#369094]/20">
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest">{(t as any).systemTitle || "Digital Consultation System"}</span>
          </div>
        ...
        <div className="flex glass p-1.5 rounded-2xl shadow-sm self-start md:self-end">
          <button
            ...
            className={clsx(
              ...
              lang === "en" ? "bg-white text-[#369094] shadow-sm" : "text-slate-500 hover:text-slate-800"
            )}
          >EN</button>
          <button
            onClick={() => setLang("ar")}
            className={clsx(
              "px-4 py-2 rounded-xl text-sm font-bold transition-all duration-300",
              lang === "ar" ? "bg-white text-[#369094] shadow-sm" : "text-slate-500 hover:text-slate-800"
            )}
          >AR</button>
        </div>
      </header>
        ...
        <div className="animate-scale-in">
          <Card className="text-center py-16 px-6 relative overflow-hidden">
            ...
            <div className="flex flex-col items-center space-y-6">
              ...
              <div className="space-y-2">
                <h2 className="text-3xl font-bold text-slate-900">{(t as any).sentSuccessfully}</h2>
                <p className="text-slate-500 font-medium max-w-md mx-auto">{t.success}</p>
              </div>
              <Button variant="brand" size="lg" onClick={clearForm} className="min-w-[200px]">
                {(t as any).submitAnother}
              </Button>
            </div>
          </Card>
        </div>
